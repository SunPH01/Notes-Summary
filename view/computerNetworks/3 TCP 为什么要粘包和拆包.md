...
**TCP 是一个传输层协议**。TCP 发送数据的时候，往往不会将数据一次性发送，而是将数据拆分成很多个部分，然后再逐个发送。像下图这样：

![image-20210730112507669](../../images/computerNetworks/image-20210730112507669.png)
...
![image-20210730112613224](../../images/computerNetworks/image-20210730112613224.png)
...
![image-20210730141121588](../../images/computerNetworks/image-20210730141121588.png)
...
- Window 也是 TCP 保证稳定性并进行流量控制的工具，我们会在“04 | TCP 的稳定性：滑动窗口和流速控制是怎么回事？”中详细介绍。
...
![image-20210730144104577](../../images/computerNetworks/image-20210730144104577.png)
...
![image-20210802161941581](../../images/computerNetworks/image-20210802161941581.png)
...
![image-20210825141125323](../../images/computerNetworks/image-20210825141125323.png)
