...
注： 关于框架的 HMR，因为在大多数情况下是开箱即用的，所以这里不做过多介绍，详细可以参考：[React HMR 方案](https://github.com/gaearon/react-hot-loader)；[Vue.js HMR 方案](https://vue-loader.vuejs.org/guide/hot-reload.html)。
