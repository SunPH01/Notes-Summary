...
![image-20210726182518947](../../../images/image-20210726182518947.png)
...
![image-20210726182942040](../../../images/image-20210726182942040.png)

这里的打包结果跟我们在第二讲中分析的是一样的，源代码中的一个模块对应这里的一个函数。

我们这里注意一下 components 对应的这个模块，虽然外部没有使用这里的 Link 函数和 Heading 函数，但是仍然导出了它们。

![img](C:\Users\Admin\AppData\Local\Temp\企业微信截图_16272958907551.png)
...
<img src="C:\Users\Admin\AppData\Local\Temp\企业微信截图_16272959309515.png" alt="img" style="zoom:75%;" />
...
![image-20210726184207159](../../../images/image-20210726184207159.png)
...
配置完成过后，我们打开命令行终端，安装babel`npm i babel-loader --save-dev` `npm i @babel/core --save-dev ` `npm i @babel/preset-env --save-dev`  ，然后运行 Webpack 打包命令，然后再找到 bundle.js，具体结果如下：
...
![image-20210727160442845](../../../images/image-20210727160442845.png)

通过查阅 babel-loader 模块的源码，我们发现它已经在 injectCaller 函数中标识了当前环境支持 ES Modules。

然后再找到我们所使用的 @babal/preset-env 模块源码（源码位于@babel/preset-env/lib/index.js），部分核心代码如下：

![image-20210727161150133](../../../images/image-20210727161150133.png)

![image-20210727161222163](../../../images/image-20210727161222163.png)
...
![img](C:\Users\Admin\AppData\Local\Temp\企业微信截图_16273779449389.png)
...
![img](C:\Users\Admin\AppData\Local\Temp\企业微信截图_16273790385538.png)

![image-20210727174924327](../../../images/image-20210727174924327.png)
...
![img](C:\Users\Admin\AppData\Local\Temp\企业微信截图_16273789878496.png)
...
![image-20210727175938923](../../../images/image-20210727175938923.png)
...
总结一下，今天介绍到了两个 Webpack 中的高级特性，分别是 Tree-shaking 和 sideEffects。
